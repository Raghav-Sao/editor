      ...
      >
        ...
        {activeType === 'text' && (
          <div className={`text__editor__tool ${activeType === 'text' ? 'active' : ''}`}>
            ...
            <div className="text__align__wrapper">
              <label className="btn" onClick={e => this.toggleTextAlignFilter()}>
                <i className={`fa fa-align-${activeStyle.textAlign}`} />
              </label>

              {this.state.showTextAlignFilter && (
                <div className="text__align__container">
                  <input
                    id="text__left"
